		...
		<>
			...
			<main>
				...
				<form action='https://indieauth.com/auth' method='GET'>
					...
					<input type='hidden' name='me' value={config.baseUrl.href} />
					<input type='hidden' name='client_id' value={config.baseUrl.href} />
					<input
						type='hidden'
						name='redirect_uri'
						value={new URL('/.denizen/indieauth-cb', config.baseUrl).href}
					/>
				</form>
			</main>
		</>
